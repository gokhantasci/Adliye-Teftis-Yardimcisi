<?php
  /**
   * ========================================
   * GEREKÇELİ KARAR ZAMAN KONTROLÜ
   * ========================================
   * 
   * Bu modül, gerekçeli karar yazım sürelerinin kontrolü için
   ...
   * - gerekcelikarar.js: İş mantığı ve veri işleme
   * 
   * @package Adliye-Teftiş-Yardımcısı
   * @subpackage Gerekçeli Karar Modülü
   * @author Gökhan TAŞCI
   * @version 1.0
   * ========================================
   */
  ...
  <section id="htkGrid" style="display:grid;grid-template-columns:5fr 1fr;gap:16px;align-items:start">
    ...
    <aside id="col2">
      ...
      <section class="card" style="margin-bottom:12px">
        ...
        <div class="card-body">
          <p>
            Tarafınıza gönderilen <strong>Gerekçeli Karar Zaman Kontrolü</strong> 
      ...
      <section class="card card-upload" id="udfUploadCard">
        ...
        <div class="card-body" style="display:block">
          ...
          <div id="udfDrop" class="placeholder" style="text-align:center;padding:18px;cursor:pointer">
            ...
            <div class="xls-loading-inline" id="xlsInlineSpinnerGk" aria-hidden="true" style="margin-top:8px">
...
<!-- Gerekçeli Karar modülü ana mantık dosyası -->
<script src="/assets/js/gerekcelikarar.js?v=1"></script>
